...
var Arena = function (_Phaser$Scene) {
    _inherits(Arena, _Phaser$Scene);
    ...
    _createClass(Arena, [{
        ...
        value: function preload() {
            this.load.scenePlugin('mergedInput', _main2.default);
        ...
        value: function create() {
            ...
            this.players = Array.from(new Array(this.numberOfPlayers)).map(function (_, i) {
                return _this2.mergedInput.addPlayer(i);
            });
            console.dir(this.players);

            // Define keys (player, action, key, append)
            this.mergedInput.defineKey(0, 'UP', 'W').defineKey(0, 'DOWN', 'S').defineKey(0, 'LEFT', 'A').defineKey(0, 'RIGHT', 'D').defineKey(1, 'UP', 'UP').defineKey(1, 'DOWN', 'DOWN').defineKey(1, 'LEFT', 'LEFT').defineKey(1, 'RIGHT', 'RIGHT').defineKey(0, 'B0', 'ONE').defineKey(0, 'B1', 'TWO').defineKey(0, 'B2', 'THREE').defineKey(0, 'B3', 'FOUR').defineKey(0, 'B4', 'FIVE').defineKey(0, 'B5', 'SIX').defineKey(0, 'B6', 'SEVEN').defineKey(0, 'B7', 'EIGHT').defineKey(0, 'B8', 'NINE').defineKey(0, 'B9', 'ZERO').defineKey(1, 'B0', 'NUMPAD_ONE').defineKey(1, 'B1', 'NUMPAD_TWO').defineKey(1, 'B2', 'NUMPAD_THREE').defineKey(1, 'B3', 'NUMPAD_FOUR').defineKey(1, 'B4', 'NUMPAD_FIVE').defineKey(1, 'B5', 'NUMPAD_SIX').defineKey(1, 'B6', 'NUMPAD_SEVEN').defineKey(1, 'B7', 'NUMPAD_EIGHT').defineKey(1, 'B8', 'NUMPAD_NINE').defineKey(1, 'B9', 'NUMPAD_ZERO');
            ...
            this.players.forEach(function (_, i) {
                var spaceBetween = 50;
                _this2.playerTexts[i] = _this2.add.text(50 + i * spaceBetween, 500 + i * spaceBetween, '', {
                    fontFamily: 'Arial',
                    fontSize: 14,
                ...
                function randomColor() {
                    var _Array$from$map = Array.from(new Array(3)).map(randomByte),
                        _Array$from$map2 = _slicedToArray(_Array$from$map, 3),
                        r = _Array$from$map2[0],
                        g = _Array$from$map2[1],
                        b = _Array$from$map2[2];
        ...
        value: function update() {
            ...
            try {
                for (var _iterator = this.mergedInput.players[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    for (var thisButton in thisPlayer.buttons) {
                        // do player actions
                        // (shape cycling etc.)
                    }
                }
            ...
            this.playerTexts.forEach(function (text, i) {
                text.setText(['Player ' + (i + 1) + '\', \'Gamepad: ' + (typeof _this3.mergedInput.getPlayer(i).gamepad.index === 'undefined' ? 'Press a button to connect' : _this3.mergedInput.getPlayer(i).gamepad.id), 'Directions: ' + JSON.stringify(_this3.mergedInput.getPlayer(i).direction), 'Buttons: ' + JSON.stringify(_this3.mergedInput.getPlayer(i).buttons), 'Interaction: ' + JSON.stringify(_this3.mergedInput.getPlayer(i).interaction)]);
            });
...
var _arena = __webpack_require__(/*! ./arena.js */ "./src/game/arena.js");
...
function DefineArena(mapData, numberOfPlayers) {
    var CustomArena = function (_Arena) {
        _inherits(CustomArena, _Arena);

        function CustomArena() {
            _classCallCheck(this, CustomArena);

            return _possibleConstructorReturn(this, (CustomArena.__proto__ || Object.getPrototypeOf(CustomArena)).apply(this, arguments));
        }

        _createClass(CustomArena, [{
            key: "init",
            value: function init() {
...
/***/ 0:
/*!***********************************************!*\
  !*** multi babel-polyfill ./src/game/main.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! /Users/sam/Documents/dev-academy/phaser3-merged-input/src/game/main.js */"./src/game/main.js");
